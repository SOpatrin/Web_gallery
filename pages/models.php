            ...
            <script>
                ;(function() {
                    for ( var i = 0; i <= 15; i++) {
                        ...
                        div.innerHTML = "<a href='/source/models/" + (i % 12 + 1) + ".jpg' target='_blank'></a>";
                        div.style.backgroundImage = "url(/source/models/" + (i % 12 + 1) + ".jpg)";
                        
                        img.className = "print-img";
                        img.src = "/source/models/" + (i % 12 + 1) + ".jpg";
                        img.alt = "model " + (i % 12 + 1);
